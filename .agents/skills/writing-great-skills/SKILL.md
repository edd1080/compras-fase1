...
description: "Write documents for coding agents. Use when creating or editing skills, AGENTS.md, agent instructions, lifecycle routers, or context pointers."
license: MIT
metadata:
  adf-version: "0.1.0"
  upstream-name: "writing-for-agents"
---
